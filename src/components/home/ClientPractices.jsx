  ...
  return (
    <div className="">
      <HeadingWithDivider title={t("title")} />
        ...
        <h1 className="text-center text-2xl lg:text-3xl font-semibold "> <span className="text-color6">Güçlü Savunma, </span><span className="text-color1">Etkin Sonuçlar</span></h1>
        <p className="text-sm font-light md:text-base text-gray-600">Bireysel ve kurumsal çözümlerle sizlere hizmet veriyoruz.</p>
        </div>
      ...
      <div className="flex flex-col md:flex-row w-[75%] md:w-full lg:gap-8 lg:w-[95%] justify-center items-center mx-auto cursor-pointer gap-6">
        {images.slice(0, visibleItems).map((image, index) => (
          <Link
            ...
            className={`group relative w-full h-[330px] practice-item transform transition-transform duration-500 ease-in ${
