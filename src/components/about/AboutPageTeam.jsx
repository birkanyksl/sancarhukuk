...
const AboutPageTeam = () => {
  return (
    <div className='px-6 pb-8 md:px-8 lg:px-16 flex flex-row gap-2 my-8 items-center'>
      
      <div className='flex flex-col w-1/2 lg:w-1/3 h-96 p-4  [border-radius:0px_200px_200px_0px] bg-amber-300 text-center justify-center items-center cursor-pointer shadow-lg '>
      ...
      <div className='hidden w-1/3 h-96 pl-12 border lg:flex [border-radius:200px_0px_0px_200px] bg-amber-300 justify-center items-center cursor-pointer shadow-lg'>
